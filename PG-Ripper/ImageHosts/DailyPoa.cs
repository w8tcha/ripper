...
namespace Ripper.ImageHosts
{
    ...
    /// </summary>
    public class DailyPoa : ServiceTemplate
    {
        public DailyPoa(ref string sSavePath, ref string strURL, ref string thumbURL, ref string imageName, ref int imageNumber, ref Hashtable hashTable)
        ...
        protected override bool DoDownload()
        {
            ...
            string strNewURL = strImgURL.Replace("imageview.php?image=", "images/");
