...
namespace Ripper
{
    ...
    /// <summary>
    /// Worker class to get images from FreeShare.us
    /// </summary>
    public class FreeShare : ServiceTemplate
    {
        public FreeShare(ref string sSavePath, ref string strURL, ref string thumbURL, ref string imageName, ref int imageNumber, ref Hashtable hashTable)
        ...
        protected override bool DoDownload()
        {
            ...
            strFilePath = strImgURL.Substring(strImgURL.IndexOf("view/?") + 6);
            ...
            string strNewURL = "http://freeshare.us/" + strImgURL.Substring(strImgURL.IndexOf("view/?") + 6);
            //////////////////////////////////////////////////////////////////////////
