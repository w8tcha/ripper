...
namespace Ripper
{
    ...
    /// <summary>
    /// Worker class to get images from ImagePundit.com
    /// </summary>
    public class ImagePundit : ServiceTemplate
    {
        public ImagePundit(ref string sSavePath, ref string strURL, ref string thumbURL, ref string imageName, ref int imageNumber, ref Hashtable hashTable)
        ...
        protected override bool DoDownload()
        {
            ...
            string strNewURL = "http://www.imagepundit.com/" + strImgURL.Substring(strImgURL.IndexOf("entry=") + 6);
