...
namespace PGRipper
{
    ...
    public class CacheController
    {
        ...
        public void DownloadImage(string aImageUrl, string aLocalPath)
        {
            ...
            else if (aImageUrl.IndexOf(@"attachment.php") >= 0)
            {
                lThreadStart = lImageDownloader.GetForumAttachment;
            }
            ...
            else if (aImageUrl.IndexOf(@"picslibraries.blogspot.com/") >= 0)
            {
                lThreadStart = lImageDownloader.GetPicsLibraries;
            }
            ...
            else if (aImageUrl.IndexOf(@"imgdino.com/") >= 0)
            {
                lThreadStart = lImageDownloader.GetImgDino;
            }
