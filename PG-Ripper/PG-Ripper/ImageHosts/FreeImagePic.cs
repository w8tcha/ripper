// --------------------------------------------------------------------------------------------------------------------
// <copyright file="FreeImagePic.cs" company="The Watcher">
...
namespace Ripper.ImageHosts
{
    ...
    /// <summary>
    /// Worker class to get images from FreeImagePic.com
    /// </summary>
    public class FreeImagePic : ServiceTemplate
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FreeImagePic" /> class.
        /// </summary>
        ...
        public FreeImagePic(ref string savePath, ref string imageUrl, ref string thumbUrl, ref string imageName, ref int imageNumber, ref Hashtable hashtable)
        ...
        protected override bool DoDownload()
        {
            ...
            var imageDownloadURL = thumbURL.Replace(@"/thumbs/", @"/images/");

            if (imageURL.Contains("/thumbs/"))
            {
                imageDownloadURL = imageURL.Replace(@"/thumbs/", @"/images/");
            }
