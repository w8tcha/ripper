// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ImageJumbo.cs" company="The Watcher">
...
namespace Ripper.ImageHosts
{
    ...
    /// <summary>
    /// Worker class to get images from ImageJumbo.com
    /// </summary>
    public class ImageJumbo : ServiceTemplate
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ImageJumbo" /> class.
        /// </summary>
        ...
        public ImageJumbo(ref string savePath, ref string imageUrl, ref string thumbUrl, ref string imageName, ref int imageNumber, ref Hashtable hashtable)
        ...
        protected override bool DoDownload()
        {
            ...
            var match = Regex.Match(
                page,
                @"img src=\""(?<inner>[^\""]*)\"" class=\""pic\"" alt=\""(?<title>[^\""]*)\""",
