...
namespace PGRipper.ImageHosts
{
    ...
    public class ImagePicasa : ServiceTemplate
    {
        ...
        /// The hashtable.
        /// </param>
        public ImagePicasa(ref string savePath, ref string imageUrl, ref string imageName, ref Hashtable hashtable)
        ...
        protected override bool DoDownload()
        {
            ...
            var m = Regex.Match(sPage, @"popitup\('(?<inner>[^\""]*)'", RegexOptions.Singleline);
