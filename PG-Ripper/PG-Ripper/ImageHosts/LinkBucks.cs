...
namespace PGRipper
{
    ...
    public class LinkBucks
    {
        ...
        public static string LinkBucksLink(string strOrgLnk)
        {
            try
            {
                ...
                iStartSRC = strIVPage.LastIndexOf("<frame src='");

                iStartSRC += 12;

                iEndSRC = strIVPage.IndexOf("' frameborder='0' noresize='1'/>", iStartSRC);
