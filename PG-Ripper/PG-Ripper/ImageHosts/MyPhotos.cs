...
namespace Ripper
{
    ...
    /// <summary>
    /// Worker class to get images from MyPhotos.cc
    /// </summary>
    public class MyPhotos : ServiceTemplate
    {
        public MyPhotos(ref string sSavePath, ref string strURL, ref string thumbURL, ref string imageName, ref int imageNumber, ref Hashtable hashTable)
        ...
        protected override bool DoDownload()
        {
            ...
            string strNewURL = "http://celebs.myphotos.cc/hosting2/public/" + strImgURL.Substring(strImgURL.IndexOf("pview/") + 6);
