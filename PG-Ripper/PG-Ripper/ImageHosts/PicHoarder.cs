...
namespace Ripper
{
    ...
    /// <summary>
    /// Worker class to get images from PicHoarder.com
    /// </summary>
    public class PicHoarder : ServiceTemplate
    {
        public PicHoarder(ref string sSavePath, ref string strURL, ref string thumbURL, ref string imageName, ref int imageNumber, ref Hashtable hashTable)
        ...
        protected override bool DoDownload()
        {
            ...
            strFilePath = strImgURL.Substring(strImgURL.IndexOf("file=") + 5);
            ...
            strNewURL = strNewURL.Replace("viewer.php?file=", "files/");
