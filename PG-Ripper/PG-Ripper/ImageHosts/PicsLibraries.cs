...
namespace Ripper
{
    ...
    /// <summary>
    /// Worker class to get images from PicsLibraries.BlogSpot.com
    /// </summary>
    public class PicsLibraries : ServiceTemplate
    {
        public PicsLibraries(ref string sSavePath, ref string strURL, ref string thumbURL, ref string imageName, ref int imageNumber, ref Hashtable hashTable)
        ...
        protected override bool DoDownload()
        {
            ...
            strFilePath = strImgURL.Substring(strImgURL.LastIndexOf("/") + 1).Replace(".html", ".jpg");
            ...
            iStartSRC = strIVPage.IndexOf("<p><a href=\"");

            iStartSRC += 12;

            iEndSRC = strIVPage.IndexOf("\" rel=\"floatbox.1\"", iStartSRC);
