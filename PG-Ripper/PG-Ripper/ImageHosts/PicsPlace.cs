...
namespace Ripper
{
    ...
    /// <summary>
    /// Worker class to get images from PicsPlace.to
    /// </summary>
    public class PicsPlace : ServiceTemplate
    {
        public PicsPlace(ref string sSavePath, ref string strURL, ref string thumbURL, ref string imageName, ref int imageNumber, ref Hashtable hashTable)
        ...
        protected override bool DoDownload()
        {
            ...
            string strNewURL = "http://" + strImgURL.Substring(strImgURL.LastIndexOf("://") + 3, 6) + "picsplace.to/" + strImgURL.Substring(strImgURL.LastIndexOf("file=") + 5);
