...
namespace PGRipper
{
    ...
    /// <summary>
    /// Worker class to get images hosted on SuprFile.com
    /// </summary>
    public class SuprFile : ServiceTemplate
    {
        public SuprFile(ref string sSavePath, ref string strURL, ref string thumbURL, ref string imageName, ref Hashtable hTbl)
        ...
        protected override bool DoDownload()
        {
            ...
            iEndSRC = strIVPage.IndexOf("' id='mainImage'", iStartSRC);
