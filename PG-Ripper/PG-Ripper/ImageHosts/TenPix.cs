...
namespace PGRipper
{
    ...
    {
        public TenPix(ref string sSavePath, ref string strURL, ref string thumbURL, ref string imageName, ref Hashtable hTbl)
        ...
        protected override bool DoDownload()
        {
            ...
            string strNewURL = "http://www.10pix.com/out.php/i" + strImgURL.Substring(strImgURL.IndexOf("show.php/") + 9);
