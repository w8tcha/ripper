...
namespace Ripper
{
    ...
    /// <summary>
    /// Worker class to get images from TheFreeImageHosting.com
    /// </summary>
    public class TheFreeImageHosting : ServiceTemplate
    {
        public TheFreeImageHosting(ref string sSavePath, ref string strURL, ref string thumbURL, ref string imageName, ref int imageNumber, ref Hashtable hashTable)
        ...
        protected override bool DoDownload()
        {
            ...
            strFilePath = strImgURL.Substring(strImgURL.LastIndexOf("Images/") + 20);
