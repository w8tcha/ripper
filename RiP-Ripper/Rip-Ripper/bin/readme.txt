RiP-Ripper and RiP-Ripper X
------------------------

Features

RiP Ripper is an image ripping tool that downloads all images in a thread or post onto your computer. 
...
Using RiP-Ripper (not with RiP-Ripper X)
