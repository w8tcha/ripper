...
namespace Ripper
{
    ...
    /// <summary>
    /// Worker class to get images from Abload.de
    /// </summary>
    public class Abload : ServiceTemplate
    {
        public Abload(ref string sSavePath, ref string strURL, ref string thumbURL, ref string imageName, ref int imageNumber, ref Hashtable hashtable)
        ...
        protected override bool DoDownload()
        {
            ...
            var strFilePath = strImgURL.Substring(strImgURL.IndexOf("img=") + 4);
            ...
            strNewURL = strNewURL.Replace("image.php?", string.Empty).Replace("=", "/");
