...
namespace Ripper
{
    ...
    /// <summary>
    /// Worker class to get images from BigPics.ru
    /// </summary>
    public class BigPics : ServiceTemplate
    {
        public BigPics(ref string sSavePath, ref string strURL, ref string thumbURL, ref string imageName, ref int imageNumber, ref Hashtable hashtable)
        ...
        protected override bool DoDownload()
        {
            ...
            iStartSRC = strIVPage.IndexOf("onLoad=\"scaleImg()\" src=\'");
