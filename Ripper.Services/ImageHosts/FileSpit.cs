// --------------------------------------------------------------------------------------------------------------------
// <copyright file="FileSpit.cs" company="The Watcher">
...
namespace Ripper.Services.ImageHosts
{
    ...
    /// <summary>
    /// Worker class to get images from FileSpit.com
    /// </summary>
    public class FileSpit : ServiceTemplate
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FileSpit" /> class.
        /// </summary>
