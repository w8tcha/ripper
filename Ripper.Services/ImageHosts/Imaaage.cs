// --------------------------------------------------------------------------------------------------------------------
// <copyright file="Imaaage.cs" company="The Watcher">
...
namespace Ripper.Services.ImageHosts
{
    ...
    /// <summary>
    /// Worker class to get images from Imaaage.com
    /// </summary>
    public class Imaaage : ServiceTemplate
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Imaaage" /> class.
        /// </summary>
        ...
        protected override bool DoDownload()
        {
            ...
            var imageDownloadURL = this.ThumbImageURL.Replace("/thumbs/", "/pics/");
