...
namespace Ripper
{
    ...
    /// <summary>
    /// Worker class to get images from Image2Share.com
    /// </summary>
    public class Image2Share : ServiceTemplate
    {
        public Image2Share(ref string sSavePath, ref string strURL, ref string thumbURL, ref string imageName, ref int imageNumber, ref Hashtable hashtable)
        ...
        protected override bool DoDownload()
        {
            ...
            string strNewURL = "http://www.image2share.com/img/" + strImgURL.Substring(strImgURL.IndexOf("image/") + 6);

            strNewURL = strNewURL.Insert(37, "img/");
