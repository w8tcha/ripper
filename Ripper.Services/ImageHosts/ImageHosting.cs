...
namespace Ripper
{
    ...
    /// <summary>
    /// Worker class to get images from ImageHosting.gr
    /// </summary>
    public class ImageHosting : ServiceTemplate
    {
        public ImageHosting(ref string sSavePath, ref string strURL, ref string thumbURL, ref string imageName, ref int imageNumber, ref Hashtable hashtable)
        ...
        protected override bool DoDownload()
        {
            ...
            strFilePath = strImgURL.Substring(strImgURL.IndexOf("_") + 1).Replace(".html", string.Empty);
            ...
            iStartSRC = sPage.IndexOf("<span id=imagecode style=\"visibility:visible\"><img src=\"");
