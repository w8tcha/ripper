...
namespace Ripper
{
    ...
    {
        public ImagesGal(ref string sSavePath, ref string strURL, ref string thumbURL, ref string imageName, ref int imageNumber, ref Hashtable hashtable)
        ...
        protected override bool DoDownload()
        {
            ...
            strFilePath = strImgURL.Substring(strImgURL.LastIndexOf("_") + 1).Replace(".html", string.Empty);
            ...
            strNewURL = strNewURL.Replace("imagesgal.com/", "imagesgal.com/upload/").Replace(".html", string.Empty);
