// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ImgClick.cs" company="The Watcher">
...
namespace Ripper.Services.ImageHosts
{
    ...
    /// <summary>
    /// Worker class to get images from ImgClick.net
    /// </summary>
    public class ImgClick : ServiceTemplate
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ImgClick" /> class.
        /// </summary>
