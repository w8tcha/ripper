// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ImgErotic.cs" company="The Watcher">
...
namespace Ripper.Services.ImageHosts
{
    ...
    /// <summary>
    /// Worker class to get images from ImgErotic.com
    /// </summary>
    public class ImgErotic : ServiceTemplate
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ImgErotic" /> class.
        /// </summary>
        ...
        protected override bool DoDownload()
        {
            ...
            var imageDownloadURL = ThumbImageURL.Replace("_thumb", string.Empty);
