// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ImgMega.cs" company="The Watcher">
...
namespace Ripper.Services.ImageHosts
{
    ...
    /// <summary>
    /// Worker class to get images from ImgMega.com
    /// </summary>
    public class ImgMega : ServiceTemplate
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ImgMega" /> class.
        /// </summary>
