...
namespace Ripper.Services.ImageHosts
{
    ...
    /// </summary>
    public class ImgTrex : ServiceTemplate
    {
        /// <summary>
        ...
        public ImgTrex(ref string savePath, ref string imageUrl, ref string thumbUrl, ref string imageName, ref int imageNumber, ref Hashtable hashtable)
        ...
        protected override bool DoDownload()
        {
            ...
            var match = Regex.Match(
                page,
                @"src=\""(?<inner>[^\""]*)\"" style=""cursor: pointer;"" class=\""pic\"" alt=\""(?<title>[^\""]*)\""", 
