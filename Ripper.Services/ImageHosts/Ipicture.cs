...
namespace Ripper.Services.ImageHosts
{
    ...
    /// <summary>
    /// Worker class to get images from Immage.de
    /// </summary>
    public class Immage : ServiceTemplate
    {
        public Immage(ref string sSavePath, ref string strURL, ref string thumbURL, ref string imageName, ref int imageNumber, ref Hashtable hashtable)
        ...
        protected override bool DoDownload()
        {
            ...
            const string sStartSrc = "alt=\"Zoom In\" src=\"";
