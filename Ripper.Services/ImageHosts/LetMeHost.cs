...
namespace Ripper
{
    ...
    /// <summary>
    /// Worker class to get images from LetMeHost.com
    /// </summary>
    public class LetMeHost : ServiceTemplate
    {
        public LetMeHost(ref string sSavePath, ref string strURL, ref string thumbURL, ref string imageName, ref int imageNumber, ref Hashtable hashtable)
        ...
        protected override bool DoDownload()
        {
            ...
            var strNewURL = "http://" + strImgURL.Substring(strImgURL.IndexOf("://") + 3, 4) + "letmehost.com/"
                            + strImgURL.Substring(strImgURL.IndexOf("file=") + 5);
