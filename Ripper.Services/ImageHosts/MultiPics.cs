...
namespace Ripper
{
    ...
    /// <summary>
    /// Worker class to get images from MultiPics.net
    /// </summary>
    public class MultiPics : ServiceTemplate
    {
        public MultiPics(ref string sSavePath, ref string strURL, ref string thumbURL, ref string imageName, ref int imageNumber, ref Hashtable hashtable)
