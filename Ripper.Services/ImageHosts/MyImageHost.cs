...
namespace Ripper
{
    ...
    /// <summary>
    /// Worker class to get images from My-Image-Host.com
    /// </summary>
    public class MyImageHost : ServiceTemplate
    {
        public MyImageHost(ref string sSavePath, ref string strURL, ref string thumbURL, ref string imageName, ref int imageNumber, ref Hashtable hashtable)
