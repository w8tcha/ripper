// --------------------------------------------------------------------------------------------------------------------
// <copyright file="Perverzia.cs" company="The Watcher">
...
namespace Ripper.Services.ImageHosts
{
    ...
    /// <summary>
    /// Worker class to get images from Perverzia.com
    /// </summary>
    public class Perverzia : ServiceTemplate
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Perverzia" /> class.
        /// </summary>
