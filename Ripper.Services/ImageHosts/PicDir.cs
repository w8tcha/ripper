...
namespace Ripper.Services.ImageHosts
{
    ...
    /// <summary>
    /// Worker class to get images from PicDir.de
    /// </summary>
    public class PicDir : ServiceTemplate
    {
        public PicDir(ref string sSavePath, ref string strURL, ref string thumbURL, ref string imageName, ref int imageNumber, ref Hashtable hashtable)
        ...
        protected override bool DoDownload()
        {
            ...
            string sStartSrc = string.Format("<img src=\"images/{0}\" alt=\"", strImgURL.Substring(strImgURL.LastIndexOf("=") + 1));
