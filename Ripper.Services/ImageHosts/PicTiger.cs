...
namespace Ripper
{
    ...
    {
        public PicTiger(ref string sSavePath, ref string strURL, ref string thumbURL, ref string imageName, ref int imageNumber, ref Hashtable hashtable)
        ...
        protected override bool DoDownload()
        {
            ...
            var strFilePath = strImgURL.Substring(strImgURL.IndexOf("picture-hosting/") + 16);
