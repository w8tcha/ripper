...
namespace Ripper.Services.ImageHosts
{
    ...
    {
        public PornImgHost(ref string sSavePath, ref string strURL, ref string thumbURL, ref string imageName, ref int imageNumber, ref Hashtable hashtable)
        ...
        protected override bool DoDownload()
        {
            ...
            var strNewURL = strImgURL.Replace("viewer.php?file=", "fullsize/");
