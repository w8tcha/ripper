// --------------------------------------------------------------------------------------------------------------------
// <copyright file="PremiumPics.cs" company="The Watcher">
...
namespace Ripper.Services.ImageHosts
{
    ...
    /// <summary>
    /// Worker class to get images from PremiumPics.net
    /// </summary>
    public class PremiumPics : ServiceTemplate
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PremiumPics" /> class.
        /// </summary>
        ...
        protected override bool DoDownload()
        {
            ...
            var imageDownloadURL = this.ThumbImageURL.Replace("thumbs/", string.Empty);
