...
namespace Ripper
{
    ...
    /// <summary>
    /// Worker class to get images from Rip-HQ.com
    /// </summary>
    public class RipHq : ServiceTemplate
    {
        public RipHq(ref string sSavePath, ref string strURL, ref string thumbURL, ref string imageName, ref int imageNumber, ref Hashtable hashtable)
        ...
        protected override bool DoDownload()
        {
            ...
            var strNewURL = "http://www.rip-hq.com/templates/members/download/loadfile.php?id="
