...
namespace Ripper.Services.ImageHosts
{
    ...
    /// <summary>
    /// Worker class to get images from 7Bucket.com
    /// </summary>
    public class SevenBucket : ServiceTemplate
    {
        public SevenBucket(ref string sSavePath, ref string strURL, ref string thumbURL, ref string imageName, ref int imageNumber, ref Hashtable hashtable)
        ...
        protected override bool DoDownload()
        {
            ...
            var iEndSrc = sPage.IndexOf("\" class=\"pic\"", iStartSrc);
