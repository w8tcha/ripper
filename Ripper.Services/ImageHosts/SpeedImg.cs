...
namespace Ripper
{
    ...
    /// <summary>
    /// Worker class to get images from SpeedIMG.com
    /// </summary>
    public class SpeedImg : ServiceTemplate
    {
        public SpeedImg(ref string sSavePath, ref string strURL, ref string thumbURL, ref string imageName, ref int imageNumber, ref Hashtable hashtable)
        ...
        protected override bool DoDownload()
        {
            ...
            strFilePath = strImgURL.Substring(strImgURL.LastIndexOf("file=") + 5);
