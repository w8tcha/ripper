// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ViewCube.cs" company="The Watcher">
...
namespace Ripper.Services.ImageHosts
{
    ...
    /// <summary>
    /// Worker class to get images from ViewCube.org
    /// </summary>
    public class ViewCube : ServiceTemplate
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ViewCube" /> class.
        /// </summary>
        ...
        protected override bool DoDownload()
        {
            ...
            var imageDownloadURL = this.ThumbImageURL.Replace("/thumb", string.Empty);
