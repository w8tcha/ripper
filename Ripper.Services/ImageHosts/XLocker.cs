// --------------------------------------------------------------------------------------------------------------------
// <copyright file="XLocker.cs" company="The Watcher">
...
namespace Ripper.Services.ImageHosts
{
    ...
    /// <summary>
    /// Worker class to get images from XLocker.net
    /// </summary>
    public class XLocker : ServiceTemplate
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="XLocker" /> class.
        /// </summary>
        ...
        public XLocker(ref string savePath, ref string imageHostURL, ref string thumbURL, ref string imageName, ref int imageNumber, ref Hashtable hashTable)
