...
namespace Ripper
{
    ...
    /// <summary>
    /// Worker class to get images from ImageWam.com
    /// </summary>
    public class ImageWam : ServiceTemplate
    {
        public ImageWam(ref string sSavePath, ref string strURL, ref string thumbURL, ref string imageName, ref int imageNumber, ref Hashtable hashtable)
        ...
        protected override bool DoDownload()
        {
            ...
            string strFilePath = strImgURL.Substring(strImgURL.IndexOf("file=") + 5);
            ...
            strNewURL = strNewURL.Replace("viewer.php?file=", "images/");
