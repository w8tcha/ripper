...
namespace Ripper
{
    ...
    /// <summary>
    /// Worker class to get images from PicturesHoster.com
    /// </summary>
    public class PicturesHoster : ServiceTemplate
    {
        public PicturesHoster(ref string sSavePath, ref string strURL, ref string thumbURL, ref string imageName, ref int imageNumber, ref Hashtable hashtable)
        ...
        protected override bool DoDownload()
        {
            ...
            strNewURL = strNewURL.Replace("hosted-pictures/jpg/", "files/").Replace(".html", ".jpg");
