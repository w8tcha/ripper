...
namespace Ripper
{
    ...
    /// <summary>
    /// Worker class to get images from PixHosting.info
    /// </summary>
    public class PixHosting : ServiceTemplate
    {
        public PixHosting(ref string sSavePath, ref string strURL, ref string thumbURL, ref string imageName, ref int imageNumber, ref Hashtable hashtable)
        ...
        protected override bool DoDownload()
        {
            ...
            strNewURL = Regex.Replace(strNewURL, "view_image", "show_image");
