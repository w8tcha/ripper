...
namespace Ripper
{
    ...
    /// <summary>
    /// Worker class to get images from ImageCargo.com
    /// </summary>
    public class ImageCargo : ServiceTemplate
    {
        public ImageCargo(ref string sSavePath, ref string strURL, ref string thumbURL, ref string imageName, ref int imageNumber, ref Hashtable hashtable)
        ...
        protected override bool DoDownload()
        {
            ...
            string strFilePath = strImgURL.Substring(strImgURL.LastIndexOf("&/") + 2);
            ...
            strNewURL = strNewURL.Replace("view.php", "img.php");
