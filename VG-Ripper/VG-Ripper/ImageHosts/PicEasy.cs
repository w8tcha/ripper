...
namespace Ripper
{
    ...
    /// <summary>
    /// Worker class to get images from PicEasy.com
    /// </summary>
    public class PicEasy : ServiceTemplate
    {
        public PicEasy(ref string sSavePath, ref string strURL, ref string thumbURL, ref string imageName, ref int imageNumber, ref Hashtable hashtable)
        ...
        protected override bool DoDownload()
        {
            ...
            strFilePath = strImgURL.Substring(strImgURL.LastIndexOf("/") + 1).Replace("_", ".");
            ...
            strNewURL = strNewURL.Replace("picture", "files").Replace("_", ".");
