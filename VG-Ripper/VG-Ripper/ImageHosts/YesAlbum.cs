...
namespace Ripper
{
    ...
    /// <summary>
    /// Worker class to get images from YesAlbum.com
    /// </summary>
    public class YesAlbum : ServiceTemplate
    {
        public YesAlbum(ref string sSavePath, ref string strURL, ref string thumbURL, ref string imageName, ref int imageNumber, ref Hashtable hashtable)
