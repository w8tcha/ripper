...
namespace Ripper
{
    ...
    /// <summary>
    /// Worker class to get images from Watermark-IT.com
    /// </summary>
    public class watermarkIt : ServiceTemplate
    {
        public watermarkIt(ref string sSavePath, ref string strURL, ref string thumbURL, ref string imageName, ref int imageNumber, ref Hashtable hashtable)
        ...
        protected override bool DoDownload()
        {
            ...
            strFilePath = strImgURL.Substring(strImgURL.IndexOf("view/") + 5);
            ...
            string strNewURL = "http://www.watermark-it.com/images/" + strImgURL.Substring(strImgURL.IndexOf("view/") + 5);
            //////////////////////////////////////////////////////////////////////////
